...
(0, globals_1.describe)("test sdk", () => {
    ...
    globals_1.test.concurrent("tool use works", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, globals_1.expect)((_a = toolsResponse.toolCalls) === null || _a === void 0 ? void 0 : _a[0].name).toMatchInlineSnapshot(`"sales_database"`);
        (0, globals_1.expect)((_b = toolsResponse.toolCalls) === null || _b === void 0 ? void 0 : _b[0].parameters).toMatchInlineSnapshot(`
            {
              "day": "2023-09-29",
            }
        `);
